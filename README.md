...
- Intuitive User Interface (UI) with quick navigation buttons from the Home landing page.
- Ability to add clothing into a Shopping Cart
- Authentication and Authorization for both shoppers and sellers (client).
- Search capability
